...
void train_yolo(char *cfgfile, char *weightfile)
{
    ...
    printf("TRAIN > Learning Rate: %g, Momentum: %g, Decay: %g\n", net.learning_rate, net.momentum, net.decay);
...
void validate_yolo(char *cfgfile, char *weightfile)
{
    ...
    fprintf(stderr, "VALIDATE >> Learning Rate: %g, Momentum: %g, Decay: %g\n", net.learning_rate, net.momentum, net.decay);
    srand(time(0));
...
void validate_yolo_recall(char *cfgfile, char *weightfile)
{
    ...
    set_batch_network(&net, 1);
    fprintf(stderr, "VALIDATE RECALL > Learning Rate: %g, Momentum: %g, Decay: %g\n", net.learning_rate, net.momentum, net.decay);
    srand(time(0));
    ...
    for(i = 0; i < m; ++i){
        ...
        char labelpath[4096];
        printf("1: %s", path);
        find_replace(path, "images", "annotate", labelpath);
        find_replace(labelpath, "JPEGImages", "annotate", labelpath);
        find_replace(labelpath, ".jpg", ".txt", labelpath);
        find_replace(labelpath, ".JPEG", ".txt", labelpath);
        printf("2: %s", labelpath);
